        ...
        <main>
          ...
          <section className="mx-auto grid max-w-(--page-max-width) grid-cols-1 items-center gap-12 px-6 py-14 lg:grid-cols-2 lg:py-20">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href="/listings"
                  className="rounded-xl bg-(--primary-orange)  px-6 py-3 text-sm font-bold text-white transition hover:scale-105"
                >
                  Browse listings
                </a>
                ...
                <a
                  href="/post-ad"
                  className="rounded-xl border bg-(--primary-green) border-(--border-beige) text-white px-6 py-3 text-sm font-bold  transition hover:scale-105"
                >
                  Post an ad
                </a>
              </div>
            ...
            <div className="relative min-h-[360px]">
              <img
                ...
                alt="Pets in a home"
                className="absolute left-0 top-8 h-[260px] w-[72%] rounded-xl object-cover shadow-[0_10px_30px_rgba(18,53,36,0.12)]"
              />

              <img
                src="/img/about-small-1.jpg"
                alt="Pet detail"
                className="absolute right-4 top-0 h-28 w-32 rounded-xl object-cover shadow-[0_8px_20px_rgba(18,53,36,0.12)]"
              />

              <img
                src="/img/about-small-2.jpg"
                alt="Pet with owner"
                className="absolute right-0 top-36 h-32 w-40 rounded-xl object-cover shadow-[0_8px_20px_rgba(18,53,36,0.12)]"
              />

              <img
                src="/img/about-small-3.jpg"
                alt="Happy pet"
                className="absolute right-16 bottom-0 h-32 w-32 rounded-xl object-cover shadow-[0_8px_20px_rgba(18,53,36,0.12)]"
              />
            </div>
          </section>
          ...
          <section className="mx-auto max-w-[1300px] px-6 py-12">
            <div className="text-center">
              <h2 className="text-3xl font-extrabold">What makes PawHome different?</h2>
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-xl border border-(--border-beige) bg-white/85 p-6 shadow-[0_8px_24px_rgba(18,53,36,0.05)]">
                ...
                <h3 className="mt-5 text-lg font-bold ">Reviewed listings</h3>

                <p className="mt-3 text-sm leading-7">
                  We want listings to be clear, honest, and useful before people make contact.
                </p>
              </div>

              <div className="rounded-xl border border-(--border-beige) bg-white/85 p-6 shadow-[0_8px_24px_rgba(18,53,36,0.05)]">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-(--light-orange)">
                  <svg
                ...
                <h3 className="mt-5 text-lg font-bold ">Safer buying</h3>

                <p className="mt-3 text-sm leading-7 ">
                  We encourage buyers to check records, meet safely, and avoid rushed decisions.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-(--border-beige) bg-white/85 p-6 shadow-[0_8px_24px_rgba(18,53,36,0.05)]">
                ...
                <h3 className="mt-5 text-lg font-bold ">Responsible community</h3>

                <p className="mt-3 text-sm leading-7 ">
                  PawHome is for people who care about animals, not quick careless sales.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-(--border-beige) bg-white/85 p-6 shadow-[0_8px_24px_rgba(18,53,36,0.05)]">
                ...
                <h3 className="mt-5 text-lg font-bold ">Easy reporting</h3>

                <p className="mt-3 text-sm leading-7 ">
                  Users can report suspicious listings so we can review and act where needed.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mx-auto grid max-w-[1300px] grid-cols-1 items-center gap-10 px-6 py-16 lg:grid-cols-2">
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -left-5 h-24 w-24 rounded-full bg-(--soft-peach)" />
            </div>

            <div>
              <p className="text-sm font-bold uppercase tracking-[0.18em] text-(--primary-green)">A personal project</p>

              <h2 className="mt-4 text-3xl font-extrabold">Built by animal people</h2>
              ...
              <button
                ...
                className="mt-4 inline-flex items-center justify-center rounded-xl bg-(--primary-green) px-6 py-3 text-sm font-bold text-white transition hover:scale-105 hover:bg-[#0A3B20] cursor-pointer"
              >
                Contact PawHome
              </button>
            </div>

        ...
        <section className="mt-8 rounded-3xl border border-(--border-beige) bg-white p-6 shadow-sm">
          ...
          <form onSubmit={saveProfile} className="mt-8 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="text-sm font-bold text-(--secondary-green)">First Name<input name="first_name" value={form.first_name || ''} onChange={updateField} required className="mt-2 h-12 w-full rounded-xl border border-(--border-beige) px-4" /></label>
              <label className="text-sm font-bold text-(--secondary-green)">Last Name<input name="last_name" value={form.last_name || ''} onChange={updateField} required className="mt-2 h-12 w-full rounded-xl border border-(--border-beige) px-4" /></label>
            </div>

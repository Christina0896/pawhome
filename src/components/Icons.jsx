...
export const ExerciseIcon = ({ className = 'h-5 w-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <circle cx="6.2" cy="4.4" r="2" />
    <path d="M5.1 7.1c.4-.6 1.1-.9 1.8-.9h1c.6 0 1.2.3 1.6.8l2.2 3.1 2.7 1.2c.8.4.5 1.6-.4 1.6-.1 0-.3 0-.4-.1l-3.1-1.4c-.3-.1-.5-.3-.7-.6L8.2 8.9l-.4 4.2 2 2.7c.2.3.3.6.4.9l.9 3.5c.2.8-.4 1.6-1.2 1.6-.6 0-1.1-.4-1.2-.9l-.9-3.2-2.1-2.8-1.1 2.7c-.1.3-.3.5-.5.8l-2 2.6c-.4.6-1.2.7-1.8.3-.6-.4-.7-1.2-.3-1.8l1.9-2.5 1.5-3.8.4-4.4c.1-.6.4-1.2 1.3-1.7Z" />
    <path d="M13.7 14.3c.3-1.2 1.4-2.1 2.7-2.1h1.9l1.4-1.2c.3-.3.8-.3 1.1 0l1.3 1.1c.4.3.5.8.4 1.2l-.4 1.1h-1.7l-.5 1.1 1.8 3.9c.3.7-.2 1.5-1 1.5-.4 0-.8-.2-1-.6l-1.5-3.2h-2.6l-.6 2.9c-.1.5-.6.9-1.1.9-.7 0-1.2-.6-1.1-1.3l.7-3.5-1.2-.6-1.2 1.1c-.4.4-1.1.4-1.5 0s-.4-1.1 0-1.5l1.9-1.8c.3-.3.7-.4 1.1-.2l1.1.5Z" />
    <circle cx="20.4" cy="13.2" r=".45" />
  </svg>
);
